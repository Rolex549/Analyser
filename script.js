...
const Api_url="https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyA4NHYYnriMPYBLxIkbGz6Q-cw_OAlZ1PU"
let fileDetails={
    mime_type:null,
    data:null
}
async function generateResponse() {
 const RequestOption={
    ...
    body:JSON.stringify({
        "contents": [{
        "parts":[
            {"text": "Analyze the following report and provide a solution of the problem."},
            {
              "inline_data": {
